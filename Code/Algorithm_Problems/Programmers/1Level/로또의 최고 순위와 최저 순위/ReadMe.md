...
- 위의 내용을 그대로 작성하기에는 너무 귀찮은 일이 될 것이라고 생각해서 algorithm 라이브러리의 find함수를 처음으로 사용해보았던 것 같다
- 평소에는 유니티 엔진만 주로 사용하다 보니 c++의 라이브러리 함수들을 사용해 볼 일이 없었어서 많이 생소하면서도 좋은 경험이었던 기억이 남는다